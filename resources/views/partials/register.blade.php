    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="h4 mb-3 ms-auto text-center">Registration Form</h1>
        ...
        <div class="modal-body">
          <form action="/register" method="post">
            ...
            <div class="input-group has-validation mb-2">
                <div class="form-floating is-invalid">
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password_regis" placeholder="Password" required>
                    <label for="password">Password</label>
                </div>
                <span class="input-group-text" onclick="password_show_hide_regis();">
